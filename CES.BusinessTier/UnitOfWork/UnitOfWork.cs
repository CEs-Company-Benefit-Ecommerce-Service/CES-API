using CES.BusinessTier.Repositories;
...
namespace CES.BusinessTier.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        private readonly CEsData_v1Context _context;

        public UnitOfWork(CEsData_v1Context context)
        {
            _context = context;
        }
